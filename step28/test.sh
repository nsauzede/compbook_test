...
assert() {
    ...
    actual=""
    gcc -S -o tmp.gcc.s -include tmp.h -O0 -fno-stack-protector -x c tmp.c.txt ; gcc -c -o tmp.o -include tmp.h -x c tmp.c.txt ; gcc -static -o tmp tmp.o tmp2.o ; ./tmp ; actual="$?"
    ...
    actual=""
    ./chibicc -S -o tmp.s -x c tmp.c.txt || exit $? && gcc -static -o tmp tmp.s tmp2.o && ./tmp ; actual="$?"
#    ./chibicc tmp.c.txt > tmp.s || exit 0 && gcc -static -o tmp tmp.s tmp2.o && ./tmp ; actual="$?"
